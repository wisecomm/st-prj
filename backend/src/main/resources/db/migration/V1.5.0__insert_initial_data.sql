...
INSERT INTO CHMM_MENU_INFO (MENU_ID, MENU_LVL, MENU_URI, MENU_IMG_URI, MENU_NAME, UPPER_MENU_ID, MENU_DESC, MENU_SEQ, USE_YN, SYS_INSERT_DTM, SYS_INSERT_USER_ID, SYS_UPDATE_DTM, SYS_UPDATE_USER_ID) VALUES
	 ...
	 ('M24000',3,'/schedules/logs','/images/menus/dashboard.svg','스케줄 로그','M20000',NULL,4,'1',CURRENT_TIMESTAMP,NULL,CURRENT_TIMESTAMP,NULL);
...
INSERT INTO CHMM_ROLE_MENU_MAP (ROLE_ID, MENU_ID, USE_YN, SYS_INSERT_DTM) VALUES
	 ...
	 ('ROLE_ADMIN','M24000','1',CURRENT_TIMESTAMP),
	 ('ROLE_ADMIN','M31000','1','2026-01-09 16:01:16.322'),
	 ('ROLE_ADMIN','M32000','1','2026-01-09 16:01:16.322');

-- 초기 테스트용 스케줄 데이터 (testPrintJob)
INSERT INTO SA_SYNC_SCHEDULE (BEAN_NAME, BEAN_PARAM, USED, DUP_STOP, CRON, COMMENT, CREATOR, UPDATER) VALUES
	 ('testPrintJob','{"test_key": "test_value"}',TRUE,FALSE,'0/10 * * * * ?','TestPrintJob 테스트','admin','admin');
